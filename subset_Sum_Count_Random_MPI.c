...
void initialize_input_array(int arr[], int size, int min, int max) {
    srand(time(NULL));
...
int main(int argc, char** argv) {
    ...
    initialize_input_array(input, sizeof(input)/sizeof(input[0]), MIN_RANDOM_VALUE, MAX_RANDOM_VALUE);
